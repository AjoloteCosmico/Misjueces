        ...
        <div class="container my-5">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <h2 class="mb-4">Documentos Legales</h2>
                    <div class="d-flex justify-content-center gap-3">
                        <button onclick="showAvisoLegal('terminos')" class="btn btn-outline-primary px-4 py-2">
                            <i class="bi bi-file-text me-2"></i>Términos y Condiciones
                        </button>
                        <button onclick="showAvisoLegal('privacidad')" class="btn btn-outline-primary px-4 py-2">
                            <i class="bi bi-shield-lock me-2"></i>Aviso de Privacidad
                        </button>
                    </div>
                </div>
            </div>
